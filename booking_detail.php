...
<?php 
$kode=$_GET['kode'];
$sql1 	= "SELECT booking.*,bus.*, merek.* FROM booking,bus,merek WHERE booking.id_bus=bus.id_bus AND merek.id_merek=bus.id_merek and booking.kode_booking='$kode'";
...
<section class="user_profile inner_pages">
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
            ...
            <div class="form-group">
			<label>Bus</label>
				<input type="text" class="form-control" name="mobil" value="<?php echo $result['nama_merek']; echo ", "; echo $result['nama_bus'];?>"readonly>
            </div>
            <div class="form-group">
			<label>Tanggal</label>
				<input type="date" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)" value="<?php echo $result['tgl'];?>"readonly>
            </div>
            <div class="form-group">
			<label>Durasi</label>
            ...
            <div class="form-group">
			<label>Tujuan</label>
				<input type="text" class="form-control" name="durasi" value="<?php echo $tujuan;?>"readonly>
            </div>
            <div class="form-group">
			<label>Biaya Bus</label>
				<input type="text" class="form-control" name="durasi" value="<?php echo format_rupiah($bus);?>"readonly>
            </div>
            <div class="form-group">
			<label>Biaya Driver+Kernet</label>
				<input type="text" class="form-control" name="durasi" value="<?php echo format_rupiah($drv);?>"readonly>
            </div>
            <div class="form-group">
			<label>Total Biaya Sewa</label><br/>
				<input type="text" class="form-control" name="total" value="<?php echo format_rupiah($bus+$drv);?>"readonly>
            </div>
