...
if(isset($_POST['update'])){
	...
	$str = substr($img,-5);
	$image2 = date('dmYHis').$str;
	$id=$_POST['id'];
	move_uploaded_file($_FILES["img1"]["tmp_name"],"img/".$image2);
	$sql="UPDATE bus SET foto_2='$image2' WHERE id_bus='$id'";
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Gambar Mobil 2 Sekarang</label>
												...
												$sql ="SELECT foto_2 FROM bus where id_bus='$id'";
												$query	= mysqli_query($koneksidb, $sql);
												$cnt=1;
												while ($result = mysqli_fetch_array($query)){
												?>
												<div class="col-sm-8">
													<img src="img/<?php echo htmlentities($result['foto_2']);?>" width="300" height="200" style="border:solid 1px #000">
												</div>
											<?php }?>
											</div>
