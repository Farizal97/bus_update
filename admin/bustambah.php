	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">
						<h2 class="page-title">Tambah Bus</h2>
					<div class="row">
						<div class="col-md-12">
							<div class="panel panel-default">
									<div class="panel-heading">Form Tambah Bus</div>
								<div class="panel-body">
									<form method="post" name="theform" action="bustambahact.php" class="form-horizontal" onsubmit="return valid(this);" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" min="1" name="seats" class="form-control" required>
										</div>
										<label class="col-sm-2 control-label">Harga /8 Jam<span style="color:red">*</span></label>
										<div class="col-sm-4">
											<input type="number" min="0" name="harga8" class="form-control" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" min="0" name="harga12" class="form-control" required>
										</div>
										<label class="col-sm-2 control-label">Harga /16 Jam<span style="color:red">*</span></label>
										<div class="col-sm-4">
											<input type="number" min="1" name="harga16" class="form-control" required>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<input type="number" min="0" name="harga24" class="form-control" required>
										</div>
										<label class="col-sm-2 control-label">Penambahan Harga(Luar Kota)<span style="color:red">*</span></label>
										<div class="col-sm-4">
											<input type="number" min="0" name="hargaluar" class="form-control" required>
										</div>
									</div>
									<div class="hr-dashed"></div>
