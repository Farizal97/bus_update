...
if(isset($_POST['update'])){
	...
	$sql="UPDATE bus SET foto_1='$image1' WHERE id_bus='$id'";
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Gambar Mobil 1 Sekarang</label>
												...
												$sql ="SELECT foto_1 FROM bus where id_bus='$id'";
												$query	= mysqli_query($koneksidb, $sql);
												$cnt=1;
												while ($result = mysqli_fetch_array($query)){
												?>
												<div class="col-sm-8">
													<img src="img/<?php echo htmlentities($result['foto_1']);?>" width="300" height="200" style="border:solid 1px #000">
												</div>
											<?php }?>
											</div>
