									...
									<div class="panel-body">
										...
										<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="menu1" class="form-control" onChange="MM_jumpMenu('parent',this,0)">
													  ...
													  <option value="manage-pages.php?type=telepon">Telepon</option>
													  <option value="manage-pages.php?type=alamat">Alamat</option>
													  <option value="manage-pages.php?type=email">Email</option>
											...
											<div class="form-group">
												...
												{
													case "telepon" :
														echo "<input type='text' class='form-control' value='Telepon' readonly>";
														break;
													case "alamat" :
														echo "<input type='text' class='form-control' value='Alamat' readonly>";
														break;
													case "email" :
														echo "<input type='text' class='form-control' value='Email' readonly>";
														break;
													case "aboutus" :
