								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										...
										$sqlsewa = "SELECT booking.*,bus.*,merek.*,users.* FROM booking,bus,merek,users WHERE booking.id_bus=bus.id_bus
													AND merek.id_merek=bus.id_merek AND users.email=booking.email AND booking.kode_booking ='$id'";
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
												<a href="../image/<?php echo $result['bukti_bayar'];?>" target="_blank"><img src="../image/<?php echo $result['bukti_bayar'];?>" width="150" height="150"></a>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-3">
									...
									<div class="panel-heading">Detail Sewa</div>
										...
										<form>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="namamobil" class="form-control" value="<?php echo $result['nama_bus'];?>" required readonly>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="selesai" class="form-control" value="<?php echo $result['tujuan'];?>" required readonly>
												</div>
											</div>
											<div class="form-group">
											&nbsp;
