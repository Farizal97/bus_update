...
?>
          <ul>
            <li>
              ...
              <div class="contact_info_m"><?php   echo htmlentities($resulta['detail']); ?></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href=""><?php   echo htmlentities($resultt['detail']); ?></a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope-o" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href=""><?php   echo htmlentities($resulte['detail']); ?></a></div>
            </li>
          </ul>
        </div>
      </div>
